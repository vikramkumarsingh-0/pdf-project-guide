...
DECLARE
  ...
  _author_id uuid;
BEGIN
  SELECT id INTO _uid FROM auth.users WHERE lower(email) = lower('kumarishubham177@gmail.com') LIMIT 1;
  ...
  IF _uid IS NOT NULL THEN
    ...
    WHERE r.user_id = u.id
      AND r.role = 'admin'
      AND lower(u.email) IS DISTINCT FROM lower('kumarishubham177@gmail.com');
